...
.\end{eqnarray}
Note that we can determine the value of $\sin(5 \pi / 8)$ using the following half-angle formula:
\begin{eqnarray}
    \sin(\frac{5\pi/4}{2}) = \sqrt{ \frac{1 - \cos(5 \pi /4)}{2} } = \sqrt{ \frac{1}{2} + \frac{1}{2\sqrt{2}}}
.\end{eqnarray}
...
which makes
\begin{eqnarray}
    \eqbox{ I_3 \approx e^{-2s} \int_{-\infty}^{\infty} e^{-(x-s)^2/s} \dd{x} = e^{-2s} \sqrt{\pi s} }
.\end{eqnarray}

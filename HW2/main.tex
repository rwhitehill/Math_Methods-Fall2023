...
\begin{eqnarray}
    \begin{aligned}
        \sum_{n=0}^{\infty} \frac{(-1)^{n}}{n^2 + a^2} &= \frac{\pi}{2 |a|} e^{- \pi |a|} + \frac{1}{a^2} + 2 \sum_{n=1}^{\infty} \int_{0}^{\infty} \frac{\cos{[(2n+1)\pi x]} + \cos{[(2n - 1)\pi x]}}{n^2 + a^2} \dd{x} \\
        &= \frac{\pi}{2|a|}e^{- \pi |a|} +\frac{1}{2 a^2} + 2 \sum_{n=1}^{\infty} \frac{\pi}{2 |a|} \Big[ e^{-(2n+1) \pi |a|}  + e^{-(2n - 1) \pi |a|} \Big] \\
        &= \frac{\pi}{2 |a|} + \frac{1}{2 a^2} + \frac{\pi}{|a|} \Big[ e^{-\pi|a|} \sum_{n=1}^{\infty} e^{-2n\pi|a|} + e^{\pi |a|} \sum_{n=1}^{\infty} e^{-2n\pi|a|} \Big] \\
        &= \frac{\pi}{2 |a|} + \frac{1}{2 a^2} + \frac{\pi}{|a|} (2 \cosh{\pi |a|}) \frac{e^{-2 \pi |a|}}{1 - e^{-2 \pi |a|}} \\
        &= \frac{1}{2a^2} + \frac{\pi}{2|a|} \Big[ 1 + 2 e^{-\pi |a|} \coth{\pi |a|} \Big]
    .\end{aligned}
\end{eqnarray}
At this point, we can subtract the $n=0$ term from both sides of the previous equation and obtain
\begin{eqnarray}
    \eqbox{ I_{2} = \sum_{n=0}^{\infty} \frac{(-1)^{n}}{n^2 + a^2} - \frac{1}{a^2} = -\frac{1}{a^2} + \frac{\pi}{2 |a|} \Big[ 1 + 2e^{-\pi |a|} \coth{\pi |a|} \Big] }
.\end{eqnarray}

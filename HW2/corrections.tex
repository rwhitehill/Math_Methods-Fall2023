...
The integration by parts is incorrect (The formula stated in terms of $f,g$ is correct but not the work carried out for the spectific example).
The answer should therefore be
\begin{eqnarray}
    I_{3} = \frac{e^{-ax}}{a} \Bigg[ \ln{x} + \sum_{n=0}^{\infty} \frac{(-1)^{n}}{(ax)^{n+1}} n! \Bigg]
.\end{eqnarray}

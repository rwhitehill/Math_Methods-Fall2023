...
\begin{eqnarray}
    \frac{\sin{x}}{x} = \prod_{n=1}^{\infty} \Big( 1 - \frac{x^2}{n \pi^2} \Big)
.\end{eqnarray}
From this formala, it is trivial to glean that $\sin{x}/x$ has zeros when $\sin{x} = 0$ or $x = n \pi$ for $n = \pm 1, \pm 2, \ldots$.
...
We can write ({\color{red} Check this})
\begin{eqnarray}
    \eqbox{ 
\begin{aligned}
